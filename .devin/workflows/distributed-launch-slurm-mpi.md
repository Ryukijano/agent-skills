# /distributed-launch-slurm-mpi

Launching multi-node PyTorch/JAX training with SLURM, torchrun, MPI, CUDA-aware MPI, and UCX.

## Trigger

When the user is working on or asking about `distributed launch slurm mpi`.

## Steps

1. Load the `distributed-launch-slurm-mpi` skill for the full reference.

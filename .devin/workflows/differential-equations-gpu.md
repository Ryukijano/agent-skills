# /differential-equations-gpu

ODE/PDE/SDE solvers, spectral and finite element methods, Diffrax, FEniCSx, PETSc, and NekRS on GPU.

## Trigger

When the user is working on or asking about `differential equations gpu`.

## Steps

1. Load the `differential-equations-gpu` skill for the full reference.

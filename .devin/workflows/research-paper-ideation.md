...
When the user is working on or asking about `research paper ideation`.

## Steps

1. Load the `research-paper-ideation` skill for the full reference.

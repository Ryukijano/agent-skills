# /quantum-state-preparation-cudaq

Prepare reference quantum states such as Hartree–Fock and Givens-rotation Slater determinants inside CUDA-Q kernels.

## Trigger

When the user is working on or asking about `quantum state preparation cudaq`.

## Steps

1. Load the `quantum-state-preparation-cudaq` skill for the full reference.

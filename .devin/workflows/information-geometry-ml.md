# /information-geometry-ml

Fisher information metric, natural gradient, alpha-connections, and geometry of probability distributions.

## Trigger

When the user is working on or asking about `information geometry ml`.

## Steps

1. Load the `information-geometry-ml` skill for the full reference.

# /generative-models-science

Diffusion, flow matching, score-based models, and normalizing flows for molecules, materials, and inverse design.

## Trigger

When the user is working on or asking about `generative models science`.

## Steps

1. Load the `generative-models-science` skill for the full reference.

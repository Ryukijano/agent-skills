# /hopper-flashattention-3

FlashAttention-3 warp specialization, WGMMA/TMA pipelining, and FP8 block quantization on H100/H200.

## Trigger

When the user is working on or asking about `hopper flashattention 3`.

## Steps

1. Load the `hopper-flashattention-3` skill for the full reference.

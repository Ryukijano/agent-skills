# /signal-image-processing-gpu

FFT, wavelets, filtering, compressed sensing, and tomography with cuFFT, RAPIDS, and GPU pipelines.

## Trigger

When the user is working on or asking about `signal image processing gpu`.

## Steps

1. Load the `signal-image-processing-gpu` skill for the full reference.

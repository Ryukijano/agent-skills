# /game-theory-multiagent-ml

Nash equilibria, mean-field games, mechanism design, and deep multi-agent reinforcement learning.

## Trigger

When the user is working on or asking about `game theory multiagent ml`.

## Steps

1. Load the `game-theory-multiagent-ml` skill for the full reference.

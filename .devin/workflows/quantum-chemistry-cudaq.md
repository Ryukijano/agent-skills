# /quantum-chemistry-cudaq

End-to-end quantum chemistry workflows from PySCF molecular integrals to CUDA-Q ground-state calculations.

## Trigger

When the user is working on or asking about `quantum chemistry cudaq`.

## Steps

1. Load the `quantum-chemistry-cudaq` skill for the full reference.

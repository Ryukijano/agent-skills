# /sports-biomechanics-ml

Wearable sensors, ST-GNNs, federated learning, and multimodal fusion for athlete performance and injury risk.

## Trigger

When the user is working on or asking about `sports biomechanics ml`.

## Steps

1. Load the `sports-biomechanics-ml` skill for the full reference.

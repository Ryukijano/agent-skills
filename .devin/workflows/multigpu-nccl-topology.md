# /multigpu-nccl-topology

NCCL, NVLink/NVSwitch, PCIe, InfiniBand/RoCE, GPUDirect, and common topology hang fixes.

## Trigger

When the user is working on or asking about `multigpu nccl topology`.

## Steps

1. Load the `multigpu-nccl-topology` skill for the full reference.

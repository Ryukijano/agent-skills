...
When the user is working on or asking about `ai for materials characterization`.

## Steps

1. Load the `ai-for-materials-characterization` skill for the full reference.

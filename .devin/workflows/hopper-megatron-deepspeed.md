# /hopper-megatron-deepspeed

Large-model training with Megatron-Core, Megatron-FSDP, DeepSpeed ZeRO, and NVLink4 on H100/H200.

## Trigger

When the user is working on or asking about `hopper megatron deepspeed`.

## Steps

1. Load the `hopper-megatron-deepspeed` skill for the full reference.

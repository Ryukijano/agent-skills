---
description: Shared Memory Swizzling Gb10 workflow
---

# Shared Memory Swizzling Gb10 on GB10

Skill: `.devin/skills/shared-memory-swizzling-gb10/SKILL.md`

## Steps
1. Read the skill at `.devin/skills/shared-memory-swizzling-gb10/SKILL.md`

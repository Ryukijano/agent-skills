...
When the user is working on or asking about `ai for total productive maintenance`.

## Steps

1. Load the `ai-for-total-productive-maintenance` skill for the full reference.

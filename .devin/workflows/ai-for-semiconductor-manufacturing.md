...
When the user is working on or asking about `ai for semiconductor manufacturing`.

## Steps

1. Load the `ai-for-semiconductor-manufacturing` skill for the full reference.

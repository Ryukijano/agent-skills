# /ml-security-supply-chain

Model signing, AIBOM/ML-BOM, container scanning, malicious pickle detection, and provenance for ML artifacts.

## Trigger

When the user is working on or asking about `ml security supply chain`.

## Steps

1. Load the `ml-security-supply-chain` skill for the full reference.

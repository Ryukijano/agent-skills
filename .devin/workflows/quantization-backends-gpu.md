# /quantization-backends-gpu

AWQ, GPTQ, AutoRound, Marlin, FP8, NVFP4, MXFP4, and backend selection for A100/H100/L40S/RTX50/GB10.

## Trigger

When the user is working on or asking about `quantization backends gpu`.

## Steps

1. Load the `quantization-backends-gpu` skill for the full reference.

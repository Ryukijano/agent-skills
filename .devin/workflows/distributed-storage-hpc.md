# /distributed-storage-hpc

Lustre, BeeGFS, GPFS, WekaFS, Ceph, Zarr, and TensorStore for high-throughput scientific data.

## Trigger

When the user is working on or asking about `distributed storage hpc`.

## Steps

1. Load the `distributed-storage-hpc` skill for the full reference.

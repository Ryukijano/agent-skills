# /custom-block-encodings-cudaq

Implement custom block encodings in CUDA-Q Algorithms and plug them into the common BlockEncoding interface.

## Trigger

When the user is working on or asking about `custom block encodings cudaq`.

## Steps

1. Load the `custom-block-encodings-cudaq` skill for the full reference.

# /astrophysics-cosmology-ml

Gravitational lensing, galaxy classification, N-body simulations, dark matter mapping, and cosmological parameter inference.

## Trigger

When the user is working on or asking about `astrophysics cosmology ml`.

## Steps

1. Load the `astrophysics-cosmology-ml` skill for the full reference.
